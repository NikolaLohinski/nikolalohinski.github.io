...
window.antoraLunr = (function (lunr) {
  ...
  function createSearchResultItem (doc, item, hits) {
    ...
    var documentTitleContent = document.createElement('span')
    documentTitleContent.innerText = doc.title
    documentTitle.appendChild(documentTitleContent)
    var documentHit = document.createElement('div')
    documentHit.classList.add('search-result-document-hit')
    var documentHitLink = document.createElement('a')
    var rootPath = window.antora.basePath
    documentHitLink.href = rootPath + item.ref
    documentHitLink.title = rootPath + item.ref
  ...
  function createNoResult (text) {
    ...
    searchResultItem.classList.add('search-result-item')
    var documentHit = document.createElement('div')
    documentHit.classList.add('no-document-hit')
    var message = document.createElement('span')
    message.innerHTML = '&#129335;&nbsp; No hits for "' + text + '"...'
